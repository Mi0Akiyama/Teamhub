                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" value="{{$taskLabel->description}}">{{ $taskLabel->description }} </textarea>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="example m-b-10">
                                        <input type="text" class="complex-colorpicker form-control" name="color"  value="{{ $taskLabel->color }}"  />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12">
