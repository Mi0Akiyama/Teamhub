...
if (!function_exists('Online_Teamwork_plugins')) {

    function Online_Teamwork_plugins()
    {

        if (!session()->has('Online_Teamwork_plugins')) {
            $plugins = \Nwidart\Modules\Facades\Module::allEnabled();

            session(['Online_Teamwork_plugins' => array_keys($plugins)]);
        }
        return session('Online_Teamwork_plugins');
    }
