...
class HomeController extends FrontBaseController
{
    ...
    public function installedModule()
    {
        ...
        $enableModules = [];
        $enableModules['application'] = 'Online_Teamwork';
        $enableModules['version'] = $applicationVersion;
        $enableModules['Online_Teamwork'] = $applicationVersion;
        ...
        if (((int)str_replace('.', '', $enableModules['Online_Teamwork'])) < 386) {
            $message .= 'Please update' . ucfirst(config('app.name')) . ' Comment';
        }
        $enableModules['message'] = $message;
